...
namespace WarehouseManagementSystem
{
    static class Common
    {
        public static string firstUrl = "http://192.168.20.145:7014/api/";
    ...
    {
        public static async Task<ClassData<List<CbmData>>> GetPlacesAsync()
        {
            return await "PlaceForStorageDetails/showAllLocation".Get<List<CbmData>>();
        }
    ...
    public static class ItemNetworkRequest
    {
        ...
        public static async Task<ClassData<T>> GetAllItemsAsync<T>()
        {
            return await "Items/showAllItems".Get<T>();
        }

        public static async Task<ClassData<T>> AddItemAsync<T>(this ItemInfo item)
        {
        ...
        public static async Task<ClassData<T>> EditItemAsync<T>(this ItemInfo item)
        {
